...
### ⚙️ Core Programming & Java Mastery
...
> OOP · SOLID · GoF Design Patterns · Generics · Collections · Streams & Lambdas  
> JVM Internals · Memory Management · Multithreading · CompletableFuture · **Virtual Threads (Java 21)**  
> IoC · DI (Constructor Injection) · AOP
...
![gRPC](https://img.shields.io/badge/gRPC_/_Protobuf-244c5a?style=for-the-badge&logo=google&logoColor=white)
![SOAP](https://img.shields.io/badge/SOAP_/_WSDL-0769AD?style=for-the-badge&logo=w3c&logoColor=white)
![WebSocket](https://img.shields.io/badge/WebSocket-010101?style=for-the-badge&logo=socketdotio&logoColor=white)

> **REST:** Idempotency · Pagination · HATEOAS · OpenAPI/Swagger  
> **GraphQL:** Query/Mutation · BatchMapping (DataLoader) · N+1 Problem Solving  
> **gRPC:** Unary · Server/Client/Bi-directional Streaming · Protobuf Contracts  
> **SOAP:** WSDL · XML Messaging · WS-Security  
> **Protocols:** HTTP/2 · HTTPS · WebSocket (STOMP)
...
> JWT (Stateless) · OAuth2 · OpenID Connect · RBAC · AES-256 Encryption  
> Spring Security (Filter Chain) · Passport.js · bcrypt · Rate Limiting (Bucket4j)
...
![Firebase](https://img.shields.io/badge/Firestore-DD2C00?style=for-the-badge&logo=firebase&logoColor=white)

> **SQL:** Query Optimization (EXPLAIN ANALYZE) · Transactions (ACID) · Indexing · PostGIS  
> **ORM:** Hibernate · JPA · Prisma  
> **Migrations:** Flyway · Liquibase  
> **Search:** pgvector (Semantic Search) · PostGIS (Spatial Queries)  
...
> **Sync:** REST · gRPC · OpenFeign · SOAP  
> **Async:** Apache Kafka · RabbitMQ · BullMQ  
> **Patterns:** Saga · Outbox · CQRS · Circuit Breaker (Resilience4j) · Distributed Lock  
> **Caching:** Redis (Cache-Aside) · Connection Pooling (HikariCP)
...
> **CI/CD:** GitHub Actions · Docker Compose · Vercel Edge
...
> **AI/ML:** RAG · Semantic Embeddings · Structured Prompting · LLM Integration  
> **Voice AI:** Vapi · Twilio · Real-time Telephony Orchestration  
> **Payments:** Stripe Checkout · Subscription & Metered Billing
